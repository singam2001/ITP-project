...
function Edit() {
    ...
    const result = await Swal.fire({
     ...
     if(result.isConfirmed){await axios.put(`http://localhost:8070/api/v1/sup/${id}`, input);
     navigate('/edit');
     }else{
        navigate('/edit');
     }
  ...
  return (
    ...
    <div className='row'>
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                        <label for="exampleInputEmail1" class="form-label">SUPPLIER FULL NAME</label>
                        <input
                            name="Firstname"
                            value={input.F_name}
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                        <label for="exampleInputPassword1" class="form-label">Products</label>
                        <input
                            name="Products"
